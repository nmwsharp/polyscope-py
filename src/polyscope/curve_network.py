...
class CurveNetwork(Structure):
    ...
    @overload
    def __init__(self, name: str, nodes: ArrayLike, edges: ArrayLike | Literal["line", "loop", "segments"] | str) -> None: ...
        ...
        if instance is not None:
            ...
            if isinstance(edges, str): 
                ...
                if (len(edges_arr.shape) != 2) or (edges_arr.shape[1] != 2):
                    raise ValueError("curve network edges_arr should have shape (N_edge,2); shape is " + str(edges_arr.shape))
