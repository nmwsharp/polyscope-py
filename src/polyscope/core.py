...
class SlicePlane:
    ...
    def set_sliced_volume_mesh(self, val):
        return self.bound_slice_plane.set_sliced_volume_mesh(val)

    def get_sliced_volume_mesh(self):
        return self.bound_slice_plane.get_sliced_volume_mesh()
