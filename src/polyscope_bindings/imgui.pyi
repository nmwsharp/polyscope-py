...
def SetNextWindowPos(
    pos: Tuple[float, float], cond: ImGuiCond = 0, pivot: Tuple[float, float] = (0, 0)
) -> None: ...
...
def SetWindowSize(
    name: str, size: Tuple[float, float], cond: ImGuiCond = 0
) -> None: ...
...
def InvisibleButton(
    str_id: str, size: Tuple[float, float], flags: ImGuiButtonFlags = 0
) -> bool: ...
...
def ProgressBar(
    fraction: float,
    size_arg: Tuple[float, float] = (-1.175494e-38, 0),
...
def InputText(
    label: str, str: str, flags: ImGuiInputTextFlags = 0
) -> Tuple[bool, str]: ...
...
def InputTextWithHint(
    label: str, hint: str, str: str, flags: ImGuiInputTextFlags = 0
) -> Tuple[bool, str]: ...
def InputFloat(
    label: str,
    v: float,
...
def InputInt2(
    label: str, v: Tuple[int, int], flags: ImGuiInputTextFlags = 0
) -> Tuple[bool, Tuple[int, int]]: ...
def InputInt3(
    label: str, v: Tuple[int, int, int], flags: ImGuiInputTextFlags = 0
) -> Tuple[bool, Tuple[int, int, int]]: ...
def InputInt4(
    label: str, v: Tuple[int, int, int, int], flags: ImGuiInputTextFlags = 0
) -> Tuple[bool, Tuple[int, int, int, int]]: ...
def InputDouble(
    label: str,
    v: float,
...
def ColorEdit3(
    label: str, col: Tuple[float, float, float], flags: ImGuiColorEditFlags = 0
) -> Tuple[bool, Tuple[float, float, float]]: ...
def ColorEdit4(
    label: str, col: Tuple[float, float, float, float], flags: ImGuiColorEditFlags = 0
) -> Tuple[bool, Tuple[float, float, float, float]]: ...
def ColorPicker3(
    label: str, col: Tuple[float, float, float], flags: ImGuiColorEditFlags = 0
) -> Tuple[bool, Tuple[float, float, float]]: ...
def ColorPicker4(
    ...
    ref_col: Optional[Tuple[float, float, float, float]] = None,
) -> Tuple[bool, Tuple[float, float, float, float]]: ...
def ColorButton(
    desc_id: str,
    col: Tuple[float, float, float, float],
...
def OpenPopupOnItemClick(
    str_id: Optional[str] = None, popup_flags: ImGuiPopupFlags = 1
) -> None: ...
...
def TableSetBgColor(
    target: ImGuiTableBgTarget, color: int, column_n: int = -1
) -> None: ...
...
def EndTabBar() -> None: ...
def BeginTabItem(
    label: str, open: Optional[bool] = None, flags: ImGuiTabItemFlags = 0
) -> Tuple[bool, Optional[bool]]: ...
def EndTabItem() -> None: ...
...
def IsRectVisible(
    rect_min: Tuple[float, float], rect_max: Tuple[float, float]
) -> bool: ...
def GetTime() -> float: ...
def GetStyleColorName(idx: ImGuiCol) -> str: ...
def ColorConvertRGBtoHSV(
    rgb: Tuple[float, float, float]
) -> Tuple[float, float, float]: ...
def ColorConvertHSVtoRGB(
...
def SetNextItemShortcut(
    key_chord: ImGuiKeyChord, flags: ImGuiInputFlags = 0
) -> None: ...
...
def IsMouseHoveringRect(
    r_min: Tuple[float, float], r_max: Tuple[float, float], clip: bool = True
) -> bool: ...
...
def DebugCheckVersionAndDataLayout(
    version_str: str,
    sz_io: int,
    sz_style: int,
    sz_vec2: int,
